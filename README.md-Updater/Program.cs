...
List<string> ReadMe = new()
            {
                ...
                "",
                $"## Progression and Navigation    ![Progress](https://progress-bar.dev/{DayProgress}/?scale=25&title=projects&width=240&suffix=/25)",
                "",
...
{
    ReadMe.Add($"| [{projects[i]}: {titles[i]}](https://adventofcode.com/2022/day/{i}) | [Solution](./{projects[i]}/Program.cs) | :star::star: |");
}
